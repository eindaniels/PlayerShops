...
public class ShopGui {
    ...
    public Inventory build() {
        ...
        if (shop.isBuyEnabled()) {
            ...
            bm.lore(List.of(
                    MiniMessage.miniMessage().deserialize("<gray>Preis <dark_gray>→ <#a3ff2b>" + price(getBuyPrice()) + "€").decoration(TextDecoration.ITALIC, false)
            ));
            buy.setItemMeta(bm);
            inv.setItem(11, buy);
        }
        ...
        if (shop.isSellEnabled()) {
            ...
            sm.lore(List.of(
                    MiniMessage.miniMessage().deserialize("<gray>Verkaufswert <dark_gray>→ <#a3ff2b>" + price(shop.getSellPrice()) + "€").decoration(TextDecoration.ITALIC,false)
            ));
            sell.setItemMeta(sm);
            inv.setItem(15, sell);
        }
